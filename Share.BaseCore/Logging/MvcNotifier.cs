...
namespace Share.BaseCore.Logging
{
    ...
    public static class IMvcNotifierExtension
    {
        ...
        public static void Information(this IMvcNotifier notifier, string message, bool durable = true)
        {
            notifier.Add(MvcNotifyType.Info, message, durable);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Success(this IMvcNotifier notifier, string message, bool durable = true)
        {
            notifier.Add(MvcNotifyType.Success, message, durable);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Warning(this IMvcNotifier notifier, string message, bool durable = true)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Error(this IMvcNotifier notifier, string message, bool durable = true)
        {
