...
dotnet ef dbcontext scaffold "Data Source=desktop-itlr9t6;Initial Catalog=WarehouseManagement;Integrated Security=True" Oracle.EntityFrameworkCore -o Entity -c WareHouseContext -f --context-dir Contexts